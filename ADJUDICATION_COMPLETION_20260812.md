...
- `data/third_party_rereview_decisions_20260824.csv` preserves the integrated 410 OY decisions.
- `data/adjudicated_study_level_coding_matrix_199.csv` is the sole source for final descriptive distributions.
- `data/adjudication_log_199_all_fields.csv` preserves the decision path for all 995 controlled study-field assignments, including two U17 post-adjudication evidence corrections and one C11 (MALF) official-record correction.
