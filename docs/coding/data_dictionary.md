...
| `data/adjudication/adjudication_log_199_all_fields.csv` | Study-field assignment | Full adjudication audit log for all 995 controlled study-field assignments: 583 unchanged agreements, 409 OY rereviews, two U17 corrections, and one C11/MALF official-record correction. |
