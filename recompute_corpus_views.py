...
summary=[
 ...
 {'stage':'Study-level coded records','count':canon_counts['study_level_coded'],'note':'67 target-software studies plus one governance boundary record; reliability is reported separately for the frozen 31-record and 41-record update rounds.'},
 {'stage':'Extended synthesis studies','count':canon_counts['extended_synthesis'],'note':'Canonical extended-synthesis studies after version resolution and submission-update integration.'},
